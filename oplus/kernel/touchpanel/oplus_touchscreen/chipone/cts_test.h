...
extern int disable_fw_monitor_mode(struct cts_device *cts_dev);
extern int set_fw_work_mode(struct cts_device *cts_dev, u8 mode);

extern void cts_dump_tsdata(struct cts_device *cts_dev,
        const char *desc, const u16 *data, bool to_console, bool is_fs_mode);
